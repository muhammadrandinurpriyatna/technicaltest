				...
				<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="1-tab" tabindex="0">
					<div class="row">
						...
						<div v-if="!moviesStore.fetchError" v-for="movie in moviesStore.moviesList" :key="movie.imdbID" class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								<NuxtLink :to="'/' + movie.imdbID" class="item__cover">
									<img :src="movie.Poster === 'N/A' ? '/img/covers/1.png' : movie.Poster" :alt="movie.Title + ' poster'">
								...
								<div class="item__content">
									<h3 class="item__title">
										<NuxtLink :to="'/' + movie.imdbID">{{ movie.Title }}</NuxtLink>
									</h3>
								</div>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="2-tab" tabindex="0">
					<div class="row">
						...
						<div v-if="!seriesStore.fetchError" v-for="series in seriesStore.seriesList" :key="series.imdbID" class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								<NuxtLink :to="'/' + series.imdbID" class="item__cover">
									<img :src="series.Poster === 'N/A' ? '/img/covers/1.png' : series.Poster" :alt="series.Title + ' poster'">
									<span class="item__play">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg>
									</span>
								</NuxtLink>
								<div class="item__content">
									<h3 class="item__title">
										<NuxtLink :to="'/' + series.imdbID">{{ series.Title }}</NuxtLink>
									</h3>
								</div>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="3-tab" tabindex="0">
					<div class="row">
						...
						<div v-if="!episodesStore.fetchError" v-for="episode in episodesStore.episodesList" :key="episode.imdbID" class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								<NuxtLink :to="'/' + episode.imdbID" class="item__cover">
									<img :src="episode.Poster === 'N/A' ? '/img/covers/1.png' : episode.Poster" :alt="episode.Title + ' poster'">
									<span class="item__play">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg>
									</span>
								</NuxtLink>
								<div class="item__content">
									<h3 class="item__title">
										<NuxtLink :to="'/' + episode.imdbID">{{ episode.Title }}</NuxtLink>
									</h3>
								</div>
							</div>
						</div>
